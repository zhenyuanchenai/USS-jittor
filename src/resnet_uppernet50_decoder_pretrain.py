...
class ResNet(nn.Module):
    def __init__(self,
                 ...
                 shallow=None):
        super().__init__()
        assert train_mode in ['pretrain', 'pixelattn', 'finetune','decoderpretrain'], train_mode
        if norm_layer is None:
        ...
        elif train_mode == 'decoderpretrain':
    ...
    def execute_backbone(self, x, avgpool=True):
        ...
        if self.train_mode == 'finetune' or self.train_mode == 'decoderpretrain':
            return [c1,c2,c3,x]
