...
class ResNet(nn.Module):
    def __init__(self,
        ...
        if train_mode == 'pixelattn':
            ...
            self.last_layer = LightHamHead(in_channels=[512,1024,2048],
                                           in_index=[1, 2, 3],
                                           channels=512,
                                           dropout_ratio=0.1,
    ...
    def execute_pixel_attention(self, out, threshold=0.24):  #执行pixel-attention的地方
    ...
    def inference_cluster(self, x, threshold=0.24):
